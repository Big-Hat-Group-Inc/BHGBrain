...
> import tests, and the Zod validator. The requirements below replace every "12" reference
> in the ADDED requirements above with "10". This reconciliation also resolves the
> `bulk-profile-import` "12-section" drift, since both features share the same section table.
